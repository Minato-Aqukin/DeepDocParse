...
| T49 资源撤销影响答案/Wiki/缓存 | P6 | ✅ | `test_wiki_cache_invalidation.py::test_tombstoned_source_unpublishes_wiki_and_purges_cache`；`test_federation_error_desensitization.py::test_withdrawn_source_stops_new_authorization_for_the_owner`；`test_wiki_revisions.py::test_revoke_between_model_calls_stops_next_request`；`test_federation_cache_wiring.py::test_withdrawn_collection_is_never_reused` | — |
